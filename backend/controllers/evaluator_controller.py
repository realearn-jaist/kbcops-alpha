...
from models.extract_model import load_multi_input_files, load_train_test_validation
...
def predict_func(ontology_name: str, algorithm: str, classifier: str, ):
    ...
    try:
        ...
        # Split values in files
        train_x_list, train_y_list = [], []
        for s in train_samples:
            sub, sup, label = s[0], s[1], s[2]
            sub_v = classes_e[files['classes'].index(sub)] if onto_type == "tbox" else individuals_e[files['individuals'].index(sub)]
