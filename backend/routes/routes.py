...
# create a blueprint for the ontology routes for the application
...
def extract(ontology):
    ...
    Args:
        ontology (str): The name of the ontology file
    Returns:
        dict: The response message
    """
    try:
...
def embed_route(ontology):
    ...
    """
    try:
        # get the algorithm from the query parameters
...
def predict_route(ontology, algorithm, classifier):
    """Evaluates the embeddings generated by the specified algorithm and classifier for the ontology file
...
def get_evaluate_stat(ontology, algorithm, classifier):
    """Returns the evaluation statistics of the ontology file for the specified algorithm and classifier
...
def explore_directory_endpoint():
    ...
    """
    try:
        # list all the files in the storage folder
...
def load_files(ontology_name):
    ...
    """
    try:
        # download all the files related to the ontology in .zip format
...
def delete_file(ontology_name):
    ...
    """
    try:
        # delete the ontology file and its related data
        path = get_path(ontology_name)
